 ...
 * @Describe: 类的描述信息
 */
public class AnnotationDependenceFieldInjection {
    ...
    public static void main(String[] args) {
        ...
        context.register(AnnotationDependenceFieldInjection.class);
        ...
        //通过依赖查找并且创建Bean
        AnnotationDependenceFieldInjection bean = context.getBean(AnnotationDependenceFieldInjection.class);
